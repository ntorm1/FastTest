...
class FTManager:
    ...
    def addExchange(
        ...
        Args:
            ...
            datetime_format (str, optional): The datetime format of the exchange data. Defaults to None.
        """
...
class FTManagerState:
    ...
    __members__: typing.ClassVar[
        dict[str, FTManagerState]
    ]  # value = {'INIT': <FTManagerState.INIT: 0>, 'BUILT': <FTManagerState.BUILT: 1>, 'RUNNING': <FTManagerState.RUNNING: 2>, 'FINISHED': <FTManagerState.FINISHED: 3>}
